...
![Image description](/assets/docs-pages/screens/example.png)
```
...
- **Always compress** images using [TinyPNG](https://tinypng.com/) — it's free and reduces file size by 2-3x without quality loss. Just drag the file onto the site and download the optimized version.
...
- **Documentation screenshots** → `public/assets/docs-pages/screens/`
- **Guide images** → `public/assets/docs-pages/guide/`
- **News images** → `public/assets/docs-pages/blog/`
...
You can add yourself to the [contributors page](/about-docs/contributors) and receive community gratitude!
